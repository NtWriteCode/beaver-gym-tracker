...
class _WorkoutSummaryDialogState extends State<WorkoutSummaryDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final volume = provider.getWorkoutVolume(widget.workout);
    final equivalent = provider.getFunnyWeightEquivalent(volume);
    
    final duration = widget.workout.endDateTime?.difference(widget.workout.startDateTime) ?? Duration.zero;
    final calories = widget.workout.estimatedCalories ?? 0;
